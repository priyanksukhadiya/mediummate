...
<div class="section-title listpostsbycats">
    <h2 class="d-flex justify-content-between align-items-center">
        ...
        <a class="d-block morefromcategory" href="<?php echo esc_url(get_category_link($category->term_id)); ?>">
...
<div class="row mm-posts-grid listpostsbycats thiscatstyle1 post-style-1">
    ...
    while ($posts_query->have_posts()) : $posts_query->the_post();
        ...
        <?php else : // Other posts - smaller format ?>
                    <div class="col-md-6 col-lg-6 grid-item" id="post-<?php the_ID(); ?>">
                        <div class="card post h-100">
                            <?php if (has_post_thumbnail()) : ?>
                                <a href="<?php the_permalink(); ?>">
                                    <?php the_post_thumbnail('medium_large', ['class' => 'poststyle1-img']); ?>
                                </a>
                            <?php endif; ?>
                            <div class="card-block d-flex flex-column">
                                <h2 class="card-title">
