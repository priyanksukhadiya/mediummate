...
<div class="container">
    <section class="recent-posts">
        <div class="section-title">
            <h2>
                <span><?php printf(esc_html__('Search Results For: %s', 'mediummate'), get_search_query()); ?></span>
            </h2>
        </div>
        ...
        <?php if (have_posts()) : ?>
            <div class="row mm-posts-grid h-100">
                ...
                while (have_posts()) :
                    ...
                    // Only show posts (not pages or other post types)
        ...
        <?php else : ?>
            <div class="no-results-found text-center py-5">
                <h3><?php esc_html_e('Nothing Found', 'mediummate'); ?></h3>
                <p><?php esc_html_e('Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'mediummate'); ?></p>
